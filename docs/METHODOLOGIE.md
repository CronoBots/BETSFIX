...
> Généré le 2026-07-26 07:30 UTC.
...
**Fiabilité de la calibration (globale)** : indice **97/100**, MAE 0.9, tendance **up** (n=5724). 
...
ROI **+17.0%** · réussite **85%** · **100** réglés (85✓/15✗) · cote moy **@1.38** · drawdown max **2.6%**

**Calibration** (toutes prédictions, fantômes inclus)  
MAE **2.2** (under) · réussite réelle **69%** vs confiance annoncée **67%** · n=1713
...
|---|---|---|---|
| Cartons | 52 | 62% | +1% |
| Double chance | 107 | 82% | +4% |
| Total +/- | 372 | 68% | +11% 🟢 |
| Total équipe | 356 | 71% | +15% 🟢 |
| Vainqueur | 111 | 69% | +29% 🟢 |
| Handicap | 191 | 75% | +36% 🟢 |
...
- **[A] ROI positif & stable** : ✅ (ROI +17.0%, drawdown max 2.6%, 100 réglés)
- **[B] Calibration bonne** : ❌ (MAE 2.2, verdict under, réussite 69% vs confiance 67%)
...
**État mesuré (paris joués)**  
ROI **-22.3%** · réussite **54%** · **28** réglés (15✓/13✗) · cote moy **@1.45** · drawdown max **29.2%**

**Calibration** (toutes prédictions, fantômes inclus)  
MAE **1.5** (good) · réussite réelle **62%** vs confiance annoncée **63%** · n=1810
...
**Scorecard d'optimalité**
- **[A] ROI positif & stable** : ❌ (ROI -22.3%, drawdown max 29.2%, 28 réglés)
- **[B] Calibration bonne** : ✅ (MAE 1.5, verdict good, réussite 62% vs confiance 63%)
...
**Calibration** (toutes prédictions, fantômes inclus)  
MAE **1.5** (good) · réussite réelle **57%** vs confiance annoncée **57%** · n=1417
...
- **[B] Calibration bonne** : ✅ (MAE 1.5, verdict good, réussite 57% vs confiance 57%)
