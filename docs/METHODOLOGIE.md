...
> Généré le 2026-09-13 08:01 UTC.
...
**Fiabilité de la calibration (globale)** : indice **98/100**, MAE 0.6, tendance **up** (n=11331). 
...
ROI **+13.3%** · réussite **90%** · **157** réglés (142✓/15✗) · cote moy **@1.26** · drawdown max **1.6%**

**Calibration** (toutes prédictions, fantômes inclus)  
MAE **0.6** (good) · réussite réelle **68%** vs confiance annoncée **68%** · n=8848
...
|---|---|---|---|
| Les 2 marquent | 477 | 52% | -44% 🔴 |
| Handicap | 835 | 70% | -5% |
| Total Over | 1201 | 69% | -3% |
| Total Under | 1396 | 72% | -3% |
| Cartons | 55 | 60% | +1% |
| Double chance | 884 | 76% | +1% |
| Vainqueur | 592 | 62% | +5% 🟢 |
| Total équipe | 1603 | 68% | +15% 🟢 |
...
- **[A] ROI positif & stable** : ✅ (ROI +13.3%, drawdown max 1.6%, 157 réglés)
