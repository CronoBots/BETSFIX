...
> Généré le 2026-08-09 08:34 UTC.
...
**Fiabilité de la calibration (globale)** : indice **95/100**, MAE 1.7, tendance **up** (n=3666). 
...
ROI **+18.6%** · réussite **86%** · **138** réglés (119✓/19✗) · cote moy **@1.38** · drawdown max **1.8%**

**Calibration** (toutes prédictions, fantômes inclus)  
MAE **1.7** (under) · réussite réelle **68%** vs confiance annoncée **67%** · n=2990
...
|---|---|---|---|
| Les 2 marquent | 194 | 54% | -57% 🔴 |
| Cartons | 52 | 62% | +1% |
| Double chance | 245 | 80% | +3% |
| Total +/- | 780 | 69% | +5% 🟢 |
| Total équipe | 573 | 69% | +14% 🟢 |
| Vainqueur | 200 | 64% | +18% 🟢 |
| Handicap | 281 | 75% | +36% 🟢 |
...
- **[A] ROI positif & stable** : ✅ (ROI +18.6%, drawdown max 1.8%, 138 réglés)
- **[B] Calibration bonne** : ❌ (MAE 1.7, verdict under, réussite 68% vs confiance 67%)
