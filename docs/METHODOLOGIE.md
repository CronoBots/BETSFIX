...
> Généré le 2026-07-21 07:31 UTC.
...
**Fiabilité de la calibration (globale)** : indice **96/100**, MAE 1.4, tendance **up** (n=4888). 
...
ROI **+20.1%** · réussite **86%** · **81** réglés (70✓/11✗) · cote moy **@1.4** · drawdown max **3.0%**

**Calibration** (toutes prédictions, fantômes inclus)  
MAE **2.0** (under) · réussite réelle **69%** vs confiance annoncée **67%** · n=1445
...
|---|---|---|---|
| Cartons | 38 | 61% | +1% |
| Double chance | 85 | 82% | +1% |
| Total équipe | 290 | 72% | +11% 🟢 |
| Total +/- | 327 | 68% | +13% 🟢 |
| Vainqueur | 97 | 67% | +25% 🟢 |
| Handicap | 170 | 74% | +36% 🟢 |
...
- **[A] ROI positif & stable** : ✅ (ROI +20.1%, drawdown max 3.0%, 81 réglés)
...
**État mesuré (paris joués)**  
ROI **-20.5%** · réussite **54%** · **24** réglés (13✓/11✗) · cote moy **@1.45** · drawdown max **34.1%**

**Calibration** (toutes prédictions, fantômes inclus)  
MAE **1.8** (good) · réussite réelle **63%** vs confiance annoncée **63%** · n=1521
...
**Scorecard d'optimalité**
- **[A] ROI positif & stable** : ❌ (ROI -20.5%, drawdown max 34.1%, 24 réglés)
- **[B] Calibration bonne** : ✅ (MAE 1.8, verdict good, réussite 63% vs confiance 63%)
...
**Calibration** (toutes prédictions, fantômes inclus)  
MAE **1.8** (good) · réussite réelle **57%** vs confiance annoncée **57%** · n=1247
