...
# Style de carte = « CLASSIC » UNIQUEMENT (user 2026-09-10 : styles ticket/unibet/signature SUPPRIMÉS —
...
# (fonctions de rendu TICKET _tk_form.._tk_combo_card RETIRÉES 2026-09-10)
...
CSS = """
  ...
  *{box-sizing:border-box}
  ...
  .spf-cv{background:radial-gradient(135% 130% at 50% 0%,rgba(34,184,255,.12),rgba(34,184,255,.045) 52%,rgba(34,184,255,.018) 100%);border:1px solid var(--border);border-radius:12px;
  ...
  /* (CSS des styles STYLE-E « unibet » et TICKET RETIRÉ 2026-09-10 : style CLASSIC seul) */
...
# (fonctions de rendu STYLE-E « unibet » RETIRÉES 2026-09-10)
...
def _sport_row(r: dict) -> str:
    ...
    # (branche carte LIVE « signature » RETIRÉE 2026-09-10 : style CLASSIC seul)
...
def _live_phantom_zone(sport: str) -> str:
    ...
    return _zone("lph", "Signal Live", "en direct", len(matches), _join_cards(cards),
...
def _live_phantom_settled_zone(sport: str) -> str:
    ...
    return _zone("lphs", "Signal Live — terminés", "", len(matches), note + _join_cards(cards),
