...
def apply_to_sidecar(d: dict) -> bool:
    ...
    # + ancre REJETÉE (`sharp_conflict`, favori Pinnacle opposé au marché) = abstention aussi, même si un sharp
    # de marché laissait un sharp_map non-vide (cas Sunderland-Hull). Aligné sur `_check_played_bet_sharp_anchor`.
