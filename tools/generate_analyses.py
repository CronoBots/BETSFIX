...
COMBO_MISSION = (
    ...
    "corners.\n"
    "   ⛔ N'utilise PAS NON PLUS : « premier but / premier buteur », « gagne une mi-temps / mi-temps » "
    "(non réglables — restent « en attente »), les CARTONS (règle 1), ni les TIRS TOTAUX (« Total de tirs "
    "+X.5 », « <équipe> plus de 22.5 tirs » : compte exact imprévisible, 0/2 chez nous). Les « tirs CADRÉS "
    "» avec un nombre RESTENT autorisés. Reformule toute autre idée vers un marché réglable ET fiable.\n"
