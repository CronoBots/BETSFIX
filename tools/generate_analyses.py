...
COMBO_MISSION = (
    ...
    "3) Jambes VARIÉES si possible, mais la SÉCURITÉ prime. PRIVILÉGIE les marchés que le système sait "
    "RÉGLER automatiquement (pour que le combiné se suive tout seul) : vainqueur, double chance, TOTAL "
    "de buts (Plus/Moins de X), total par ÉQUIPE (X marque +/- de N), HANDICAP, CORNERS plus/moins de N, "
    "CARTONS plus/moins de N (total ou par équipe). ÉVITE les marchés MI-TEMPS, « premier buteur » et "
    "« le plus grand nombre de corners » (non réglables auto).\n"
