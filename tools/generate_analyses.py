...
COMBO_MISSION = (
    ...
    "corners.\n"
    "   ⛔ AUCUN marché lié à UNE mi-temps PRÉCISE (1ère OU 2e) : NI buts d'une équipe en 1ère/2e MT "
    "(« <équipe> +0.5 but 1ère/2e mi-temps »), NI « gagne une mi-temps », NI résultat/score d'une "
    "mi-temps. NON RÉGLABLES (pas de données buts par équipe ET par mi-temps) → restent « en attente » "
    "et BLOQUENT le combiné. SEULE exception autorisée : « But dans les DEUX mi-temps Oui/Non » (réglable).\n"
    "   ⛔ N'utilise PAS NON PLUS : « premier but / premier buteur », les CARTONS (règle 1), ni les TIRS "
    "TOTAUX (« Total de tirs +X.5 », « <équipe> plus de 22.5 tirs » : imprévisible, 0/2 chez nous). Les "
    "« tirs CADRÉS » avec un nombre RESTENT autorisés. Reformule toute autre idée vers un marché fiable.\n"
