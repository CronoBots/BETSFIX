...
METHODO = (
    ...
    "- Mi-temps FOOT — 1re mi-temps (marché VALIDÉ chez nous, calibré : joue-le s'il est TON meilleur pari "
    "de value ≥ 65 %) : `HALFTOT 1H OVER 0.5` (buts en 1re MT) / `TEAMHALF HOME 1H OVER 0.5` (buts d'une "
    "équipe en 1re MT) / `DCHALF 1H 1X` / `DCHALF 1H X2` (double chance 1re MT)\n"
