...
METHODO = (
    ...
    "L'<explication> = la JUSTIFICATION la PLUS complète, précise et PROFESSIONNELLE de CE pari (4 à 6 "
    "phrases, TOUT se rapporte au pari) : POURQUOI il passe (forme récente CHIFFRÉE, blessés/absents "
    "déterminants, H2H, stats par équipe/joueur, contexte/enjeu, surface/repos/calendrier), la VALUE (ta "
    "proba estimée vs proba juste de la cote, ex. « ~72 % vs 64 % juste -> value nette »), et le RISQUE "
    "principal à connaître. Ton de professionnel du pari sportif, chiffres concrets, français impeccable, "
    "ZÉRO généralité ni remplissage.\n"
