...
COMBO_MISSION = (
    ...
    "3) La PROBABILITÉ prime sur TOUT. Choisis TOUJOURS les sélections les PLUS PROBABLES de CE match, "
    "QUEL QUE SOIT le marché (vainqueur, double chance, totaux, corners, cartons, premier but, mi-temps, "
    "« le plus grand nombre de corners »…). Ne te limite SURTOUT PAS aux marchés faciles à régler : si "
    "un pari mi-temps ou exotique est PLUS sûr, prends-le. Varie les marchés quand c'est possible, mais "
    "ne sacrifie JAMAIS une jambe plus probable pour une autre.\n"
