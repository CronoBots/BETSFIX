...
COMBO_MISSION = (
    ...
    "réelle Unibet ≈ ce produit (peu/pas de réduction), donc tu dépasses bien 2.00 une fois sur Unibet. "
    "Combine 3 à 4 jambes. N'utilise QUE des cotes réelles du bloc ci-dessus.\n"
